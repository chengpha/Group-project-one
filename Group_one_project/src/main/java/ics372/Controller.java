...
public class Controller {
        ...
        if (Files.exists(Paths.get(input))) {
            ...
            */
            for (Shipment s : shipmentList) {
                ...
                msg = disabledFreightReceiptDoNotAddShipment(msg, s, warehouse);
            }
    ...
    private String disabledFreightReceiptDoNotAddShipment(String msg, Shipment s, Warehouse warehouse) {
